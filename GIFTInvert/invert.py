...
def parse_args():
    ...
    parser.add_argument('--image_list', type=str, default='CelebA-HQ/test.list', help='target image folder path')
    parser.add_argument('--encoder_pt_path', type=str, default='pretrained_models/encoder_stylegan2_ffhq1024_basesize16.pth', help='base code encoder path')
